...
-import(pollution, [createMonitor/0, addStation/3, addValue/5, removeValue/4, getDailyValueCount/3, getDailyMaxValue/3, getDailyMean/3, getStationMean/3, getOneValue/4]).
